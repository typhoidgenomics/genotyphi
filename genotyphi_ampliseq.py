...
#
# Authors - Kat Holt (drkatholt@gmail.com), Zoe Dyson (zoe.dyson@lshtm.ac.uk)
#
...
def parse_args():
	...
	parser.add_argument('--version', action='version', version='GenoTyphi v' + __version__,
		help="Show GenoTyphi version number and exit")
